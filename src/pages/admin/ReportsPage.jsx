    ...
    const fetchData = async () => {
      try {
        ...
        const [pRes, cRes] = await Promise.all([
          axios.get("https://medicore-connect.onrender.com/api/admin/patients", { headers }),
          axios.get("https://medicore-connect.onrender.com/api/admin/clinical-reports", { headers })
        ]);

...
export default function AdminViewBillerProfile() {
    ...
    const fetchProfile = async () => {
        try {
            ...
            const res = await axios.get(`https://medicore-connect.onrender.com/api/admin/biller/${billerId}`, {
    ...
    const handleImageChange = async (e) => {
        ...
        reader.onloadend = async () => {
            ...
            try {
                const token = localStorage.getItem("token");
                await axios.put(`https://medicore-connect.onrender.com/api/admin/biller/${billerId}`,

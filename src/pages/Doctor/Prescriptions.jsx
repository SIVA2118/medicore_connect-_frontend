...
export default function Prescriptions() {
    ...
    useEffect(() => {
        const loadData = async () => {
            try {
                ...
                if (isEditMode) {
                    const res = await axios.get(`https://medicore-connect.onrender.com/api/doctor/prescription/${prescriptionId}`, {
                    ...
                    const res = await axios.get(`https://medicore-connect.onrender.com/api/doctor/patient/${patientId}`, {
                        headers: { Authorization: `Bearer ${token}` }
                    });
                    setPatient(res.data);
                }
    ...
    const handlePrescriptionSubmit = async (e) => {
        ...
        try {
            ...
            if (isEditMode) {
                await axios.put(`https://medicore-connect.onrender.com/api/doctor/prescription/${prescriptionId}`, payload, {
                    headers: { Authorization: `Bearer ${token}` }
                });
                alert("Prescription Updated Successfully!");
                navigate(`/doctor/prescription/view/${prescriptionId}`);
            } else {
                await axios.post("https://medicore-connect.onrender.com/api/doctor/prescription", payload, {
                    headers: { Authorization: `Bearer ${token}` }
                });

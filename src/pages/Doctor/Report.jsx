...
export default function Report() {
        ...
        const loadData = async () => {
            try {
                ...
                if (isEditMode) {
                    ...
                    const res = await axios.get(`https://medicore-connect.onrender.com/api/doctor/report/${reportId}`, {
    ...
    const handleReportSubmit = async (e) => {
        ...
        try {
            ...
            if (isEditMode) {
                await axios.put(`https://medicore-connect.onrender.com/api/doctor/report/${reportId}`, payload, {
                    headers: { Authorization: `Bearer ${token}` }
                });
                alert("Report Updated Successfully!");
                navigate(`/doctor/report/view/${reportId}`);
            } else {
                await axios.post("https://medicore-connect.onrender.com/api/doctor/report", payload, {
                    headers: { Authorization: `Bearer ${token}` }
                });

...
export default function AddPatient() {
    ...
    const fetchDoctors = async () => {
        try {
            ...
            const res = await axios.get("https://medicore-connect.onrender.com/api/receptionist/all-doctors", {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (isEditMode) {
                // UPDATE
                await axios.put(`https://medicore-connect.onrender.com/api/receptionist/patient/${editId}`, payload, {
                    headers: { Authorization: `Bearer ${token}` },
                });
                ...
                // CREATE
                await axios.post("https://medicore-connect.onrender.com/api/receptionist/create-patient", payload, {
                    headers: { Authorization: `Bearer ${token}` },
                });

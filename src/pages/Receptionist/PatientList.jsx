...
export default function PatientList() {
    ...
    const fetchPatients = async () => {
        try {
            ...
            const res = await axios.get("https://medicore-connect.onrender.com/api/receptionist/all-patients", {
    ...
    const handleDelete = async (e, id) => {
        ...
        try {
            const token = localStorage.getItem("token");
            await axios.delete(`https://medicore-connect.onrender.com/api/receptionist/patient/${id}`, {
                headers: { Authorization: `Bearer ${token}` },
            });
